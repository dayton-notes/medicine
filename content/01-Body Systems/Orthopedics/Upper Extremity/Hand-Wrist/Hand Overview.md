...
| Nerve      | Roots | Motor Test                                                                                                                                                                                                              | Sensory Test                                       |
| ---------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| **Radial** | C5–C8 | Extend the wrist. If too painful due to injury, extension of the thumb IP joint may be substituted.                                                                                                                     | Dorsal webspace between the thumb and index finger |
| **Median** | C5–T1 | **Recurrent motor branch:** Opposition (thumb tip to small finger tip). <br>**Anterior interosseus branch:** OK sign — touch tip of thumb to tip of index finger (note: an incorrect OK sign shows flexor substitution) | Palmar surface of the index finger or thumb        |
| **Ulnar**  | C8–T1 | Spread fingers against resistance                                                                                                                                                                                       | Palmar aspect of the little finger                 |

![[Pasted image 20260402083717.png]]

**CORRECT OK SIGN**
![[Pasted image 20260402083538.png]]

 **INCORRECT OK Sign**
![[Pasted image 20260402083550.png]]
...
- _Diffuse_ vs. _nerve-specific_ (e.g., thenar wasting in carpal tunnel syndrome; hypothenar + first dorsal interosseous wasting in cubital tunnel syndrome)

**Traumatic Deformity** — Check alignment in both flexion and extension. Abnormal rotation may only appear when making a fist.

| Finding                | Description                                                                                 |                                      |
| ---------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------ |
| **Mallet finger**      | Flexed DIP with inability to actively extend → rupture/avulsion of terminal extensor tendon | ![[Pasted image 20260402085109.png]] |
| **Boxer's fracture**   | "Dropped knuckle sign" — metacarpal head appears to disappear due to shaft fracture         | ![[Pasted image 20260402085059.png]] |
| **Cascade disruption** | One finger out of alignment with the others → may represent tendon injury                   | ![[Pasted image 20260402090548.png]] |
...
| Palpation Site     | Landmark          | Notes                                                                             | Image                                |
| ------------------ | ----------------- | --------------------------------------------------------------------------------- | ------------------------------------ |
| Scaphoid tubercle  | Volar wrist       | Most sensitive for scaphoid fracture (95%)                                        | ![[Pasted image 20260402091804.png]] |
| Scaphoid waist     | Anatomic snuffbox | 85% sensitive; maximize by ulnar deviation + thumb abduction                      | ![[Pasted image 20260402091838.png]] |
| Proximal scaphoid  | Dorsal wrist      | Soft spot between 3rd/4th extensor compartments, just distal to Lister's tubercle | ![[Pasted image 20260402091830.png]] |
...
Innervation: mostly **median nerve**, _except_ FCU and FDP to ring/small fingers (**ulnar nerve**)

| Structures at Risk                       | Test                                                                            |
| ---------------------------------------- | ------------------------------------------------------------------------------- |
...
| **FDS** (Flexor Digitorum Superficialis) | Hold all _other_ fingers in extension, ask patient to flex PIP of target finger |
| **FCR / FCU**                            | Ask patient to volar-flex wrist; palpate tendon/muscle contraction              |
...
| Compartment | Structures at Risk | Test                                                                                            |
| ----------- | ------------------ | ----------------------------------------------------------------------------------------------- |
| **1st**     | APL, EPB           | Abduct thumb; palpate tendons along radial wrist border                                         |
| **2nd**     | ECRL, ECRB         | Make fist, extend wrist against resistance                                                      |
| **3rd**     | EPL                | Place hand flat on table; lift thumb off surface                                                |
| **4th**     | EDC, EIP           | Extend individual fingers at MCP; isolate EIP by extending index with rest of fingers in a fist |
| **5th**     | EDM                | Extend small finger from closed fist                                                            |
| **6th**     | ECU                | Extend and ulnar-deviate wrist                                                                  |
![[Pasted image 20260402085952.png]]
...
| Group          | Muscle(s) at Risk           | Nerve  | Test                                                                                                             |
| -------------- | --------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------- |
| **Thenar**     | APB, Opponens Pollicis, FPB | Median | Touch thumb and small finger tips together so nails are parallel                                                 |
| **Thenar**     | Adductor Pollicis           | Ulnar  | Froment's sign: hold paper between thumb base and radial index finger; weakness = thumb IP flexion to compensate |
| **Lumbricals** | Lumbricals                  | Ulnar  | Flex MCP, straighten IP joints                                                                                   |
| **Interossei** | Dorsal/Palmar Interossei    | Ulnar  | Hand flat on table, hyperextend MCP, adduct/abduct fingers                                                       |
| **Hypothenar** | ADM, Opponens Digiti Minimi | Ulnar  | Abduct small finger; bring small finger toward thumb                                                             |
...
| Case                                                                                                                 | Diagnosis                                                    | Mechanism                                       | Test                                                                                                                                                                | **Example Image**                    |
| -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| **Skier's/Gamekeeper's thumb**                                                                                       | UCL rupture of thumb MCP                                     | Fall backwards onto hand while gripping         | Hold thumb metacarpal, fully extend MCP, apply radial deviation force; repeat at 30° MCP flexion. Compare to contralateral thumb.                                   | ![[Pasted image 20260402085250.png]] |
| [**Jersey finger**]([Jersey Finger - Hand - Orthobullets](https://www.orthobullets.com/hand/6015/jersey-finger))<br> | FDP avulsion from distal phalanx                             | Finger snagged, sudden distraction force        | Hold MCP and PIP in full extension → ask patient to flex DIP. Inability = positive.                                                                                 | ![[Pasted image 20260402085324.png]] |
| **Mallet finger**                                                                                                    | Extensor digitorum avulsion from distal phalanx              | Axial force to fingertip (e.g., jammed on ball) | Hold middle phalanx, ask patient to actively extend DIP. Also test if patient can hold passively extended position.                                                 | ![[Pasted image 20260402085543.png]] |
