...
- between 1.0 and 2.0 kCal / mL
	More concentrated:
	- less volume needed for daily kCal needs
	- more free water needed
	Less concentrated:
	- more volume needed for daily kCal needs
...
Common uses:
- gastric decompression ([[Small Bowel Obstruction|SBO]], ileus, gastroparesis)
- [[NPO]] patients 
...
Another method: 4hr clamp trial
- is pt tolerates (no nausea, vomit, burp, belch, hiccup, etc) then probably ok to pull
- risks: 
