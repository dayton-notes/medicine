...
| **Vasopressin**    | V1a, V1b, V2               | ↑↑ SVR <br>↑↑ BP<br>↔/↓ CO<br>↔/↓ HR | Distributive (septic), Refractory shock           | Non-adrenergic vasoconstrictor; augments SVR and BP, norepinephrine-sparing in distributive shock                                                                         |
| **Isoproterenol**  | β1 (+++), β2 (+++)         | ↓ SVR<br>↔ BP<br>↑ CO<br>↑↑ HR       | Bradycardic shock, AV block                       | Pure chronotrope/inotrope; increases HR and CO, vasodilates; limited use for severe bradycardia                                                                           |
